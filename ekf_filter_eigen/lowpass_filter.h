...
class LowpassFilter {
  public:
    ...
    void AddSample(const vector<3>& sample, uint64_t timestamp_ns);
    ...
    //     this.
    void AddWeightedSample(const vector<3>& sample, uint64_t timestamp_ns, double weight);
